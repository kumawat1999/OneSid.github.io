                ...
                success: function(respoce) {
                    ...
                    if (respoce.errors && !respoce.errors == '') {
                        $.each(respoce.errors, (key, value) => {
                            var Msg = '<label class="error formmessage error2" style="color:blue">' + value + '</label>';
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  // print_r($value);
                  ?>
                  <form class="row g-3 needs-validation" id="myform" method="post" action="<?= base_url('loginAction') ?>">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" onclick="getValidation()" type="submit">Login</button>
                    </div>
                    <!-- <div class="col-12">
